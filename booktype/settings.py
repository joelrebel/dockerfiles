...
THIS_BOOKI_SERVER = 'BOOKTYPE_HOST' # the name of the booki server (comment out to use os.environ['HTTP_HOST'])

BOOKI_ROOT = '/mybook'  # edit this
BOOKI_URL = 'BOOKTYPE_HOST'
#BOOKI_URL = 'http://%s' % THIS_BOOKI_SERVER

# E-MAIL OPTIONS
REPORT_EMAIL_USER = 'booktype@BOOKTYPE_HOST'
